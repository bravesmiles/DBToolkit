...
public class Assistances {
	...
	private void addHostFieldAssist() {
		...
		// au.setProposals(new String[]{"aaa","aab"});
	}
	...
	public static void writeToText(String value) throws IOException
	{
	    ...
	    FileWriter fw = new FileWriter(CONF.queryfile,false); //the true will append the new data
	    fw.write(content+"");	//override the content of query file
	    fw.close();
	}
}
